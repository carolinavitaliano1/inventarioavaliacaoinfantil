    ...
    <div style={{ minHeight: '100vh', background: '#f7f8fc', display: 'flex', flexDirection: 'column', fontFamily: 'inherit' }}>
      ...
      <div style={{ background: '#fff', borderBottom: '1px solid #ebebf0', padding: '14px 24px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          <a href="mailto:prof.carolgurgel@gmail.com" title="E-mail" style={{ display: 'flex', alignItems: 'center', color: '#9ca3af', transition: 'color .15s' }}
          ...
          <a href="https://www.instagram.com/institutoprofcarolgurgel/" target="_blank" rel="noopener noreferrer" title="Instagram" style={{ display: 'flex', alignItems: 'center', color: '#9ca3af', transition: 'color .15s' }}
            onMouseEnter={e => (e.currentTarget as HTMLAnchorElement).style.color = '#7c3aed'}
            onMouseLeave={e => (e.currentTarget as HTMLAnchorElement).style.color = '#9ca3af'}>
